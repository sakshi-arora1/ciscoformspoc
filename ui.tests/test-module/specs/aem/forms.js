...
describe('AEM Forms OOTB Content Tests', () => {
    ...
    describe.skip('DataSource Tests', () => {
        let dataSources = [
            ...
            confPath = '/conf/ciscoformspoc/settings/cloudconfigs/fdm',
    ...
    describe('Form Data Model Tests', () => {
        ...
        let formDataModels = [
            ...
            basePath = 'aem/fdm/editor.html/content/dam/formsanddocuments-fdm/ciscoformspoc',
    ...
    describe('AEM Forms Templates E2E Testing', () => {
        let templates = [
                {path : '/conf/ciscoformspoc/settings/wcm/templates/basic-af', isBlankForm : false, verificationRuleFilePath : '../../rules/template-rules.json'},
                {path : '/conf/ciscoformspoc/settings/wcm/templates/blank-af', isBlankForm : true}
            ],
            tabbedLayoutCount = 0,
    ...
    describe('Theme testing', () => {
        const getThemePath = (theme) => '/content/dam/formsanddocuments-themes/ciscoformspoc/' + theme + '/jcr:content?wcmmode=disabled';
    ...
    describe('DataLayer testing', () => {
        ...
        const templatePath = '/conf/ciscoformspoc/settings/wcm/templates/blank-af-v2';
